...
//        mqtt.willMessage = CocoaMQTTMessage(topic: "/will", message: "dieout")
    ...
    public func sendMessageProtobuf(mid: String, type: String, content: String, tid: String, topic: String, threadType: String, threadNickname: String, threadAvatar: String, extraParam: BDExtraParam?) {
        // debugPrint("\(#function)")
        //
...
//        } catch {}
    ...
    public func sendMessageProtobuf(mid: String, type: String, content: String, thread: BDThreadModel, extraParam: BDExtraParam?) {
        // debugPrint("\(#function)")
        sendMessageProtobuf(mid: mid, type: type, content: content, tid: thread.uid!, topic: thread.topic!, threadType: thread.type!, threadNickname: thread.user!.nickname!, threadAvatar: thread.user!.avatar!, extraParam: extraParam)
    }
...
//            } else if type == BD_MESSAGE_TYPE_IMAGE {
//                sendReceipt = true
//                messageModel.imageUrl = message.content
//            } else if type == BD_MESSAGE_TYPE_VOICE {
//                sendReceipt = true
//                messageModel.voiceUrl = message.content
//            } else if type == BD_MESSAGE_TYPE_FILE {
//                sendReceipt = true
//                messageModel.fileUrl = message.content
//            } else if type == BD_MESSAGE_TYPE_VIDEO || type == BD_MESSAGE_TYPE_SHORTVIDEO {
//                sendReceipt = true
//                messageModel.videoUrl = message.content
//            } else if type == BD_MESSAGE_TYPE_NOTIFICATION_PREVIEW {
//                // TODO: 消息预知
